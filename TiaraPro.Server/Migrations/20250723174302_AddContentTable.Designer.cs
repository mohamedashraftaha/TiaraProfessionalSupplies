...
namespace TiaraPro.Server.Migrations
{
    ...
    [Migration("20250723174302_AddContentTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TiaraPro.Server.Models.Content", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TiaraPro.Server.Models.DentalTrainingPackage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DentalTrainingPackages");
                });
            ...
            modelBuilder.Entity("TiaraPro.Server.Models.Order", b =>
                {
                    ...
                    b.Property<string>("ShippingUserFirstName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("ShippingUserLastName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");

                    b.Property<string>("ShippingUserMiddleName")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)");
            ...
            modelBuilder.Entity("TiaraPro.Server.Models.Transactions", b =>
                {
                    ...
                    b.Property<string>("DentalMeshResponseStlFolder")
                        .HasColumnType("text");

                    b.Property<string>("DentalMeshResponseStlViewUrl")
                        .HasColumnType("text");
